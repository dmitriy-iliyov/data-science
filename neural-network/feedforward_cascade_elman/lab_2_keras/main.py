from feedforward_cascade_elman.lab_2_keras.models import keras_fnn, keras_cnn, keras_enn
import feedforward_cascade_elman.lab_2.tools.data_processing as dp
from feedforward_cascade_elman.lab_2_keras.tools.network_compare import NetworkComparor
