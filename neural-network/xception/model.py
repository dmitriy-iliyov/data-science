...
class CustomizedXception:
    ...
    def __init__(self):
        ...
        self._answer_map = {0: 'logo', 1: 'not a logo'}
    ...
    def predict(self, sequence):
        ...
        return self._answer_map.get(_id)

    def save(self, path='/content/drive/MyDrive/main/languages/Python/neural_network/labs/lab_7/model/lstm_model.keras'):
        self._model.save(path)

    def load_model(self, path='/Users/sayner/github_repos/data-science/neural-network/xception/model_files/xception_model.keras'):
